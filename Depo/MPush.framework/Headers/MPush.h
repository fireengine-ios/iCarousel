...
#import "MMessageResponseNotification.h"
#import "MMessageResponse.h"
...
+ (void)         application:(UIApplication *)application
  handleActionWithIdentifier:(NSString *)identifier
       forRemoteNotification:(NSDictionary *)userInfo
           completionHandler:(MSimpleCompletionBlock)completionHandler;
...
didReceiveNotificationResponse:(UNNotificationResponse *)response
         withCompletionHandler:(MSimpleCompletionBlock)completionHandler;
 ...
 */
+ (void)registerForRemoteNotificationTypes:(MNotificationType)types;
 ...
 */
+ (void)registerForegroundNotificationOptions:(MForegroundNotificationOptions)options;
