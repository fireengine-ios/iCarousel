...
typedef void (^MMessageCompletionBlock)(void);
typedef void (^MSimpleCompletionBlock)(void);

/**
 * Callback you'll receive upon any interaction with PushNotification. If you want to leverage background processing with push notification consider using |MContinousMessageInteractionCallback|
 */
