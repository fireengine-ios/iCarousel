...
struct TextConstants {
    ...
    static let privateShareStartPageDurationDay = NSLocalizedString("private_share_start_page_share_duration_2", tableName: "OurLocalizable", bundle: .main, value: "", comment: "")
    static let privateShareStartPageDurationWeek = NSLocalizedString("private_share_start_page_share_duration_3", tableName: "OurLocalizable", bundle: .main, value: "", comment: "")
    static let privateShareStartPageDurationMonth = NSLocalizedString("private_share_start_page_share_duration_4", tableName: "OurLocalizable", bundle: .main, value: "", comment: "")
    static let privateShareStartPageDurationYear = NSLocalizedString("private_share_start_page_share_duration_5", tableName: "OurLocalizable", bundle: .main, value: "", comment: "")
