//
//  CreateCollageAlbumSelectionViewController.swift
//  Lifebox
//
...
protocol CreateCollageAlbumSelectionDelegate: AnyObject {
    func onSelectAlbum(_ album: AlbumItem)
}

final class CreateCollageAlbumSelectionViewController: UIViewController, ErrorPresenter {
    ...
    private let dataSource = CreateCollageAlbumSelectionDataSource()
    
    private let refresher = UIRefreshControl()
    
    private weak var delegate: CreateCollageAlbumSelectionDelegate?
    
    // MARK: - Life cycle
    
    init(title: String, delegate: CreateCollageAlbumSelectionDelegate?) {
...
extension CreateCollageAlbumSelectionViewController: CreateCollageAlbumSelectionDataSourceDelegate {
    func onSelectAlbum(_ album: AlbumItem) {
