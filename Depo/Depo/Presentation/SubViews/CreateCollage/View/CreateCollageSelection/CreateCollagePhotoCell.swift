...
final class CreateCollagePhotoCell: UICollectionViewCell {
    ...
    func update(for selectionState: CreateCollagePhotoSelectionState) {
        if self.isSelected {
...
final class CreateCollageCollectionSpinnerFooter: UICollectionReusableView {
