...
class LatestUpladsCard: BaseCardView {
    ...
    override func configurateView() {
        ...
        title.font = .appFont(.medium, size: 16)
        title.textColor = AppColor.label.color
        ...
        viewRecentActivitiesButton.titleLabel?.font = .appFont(.bold, size: 14)
        viewRecentActivitiesButton.setTitle(TextConstants.homeLatestUploadsCardRecentActivitiesButton, for: .normal)
        viewRecentActivitiesButton.setTitleColor(AppColor.settingsButtonColor.color, for: .normal)
        viewRecentActivitiesButton.adjustsFontSizeToFitWidth()
        
        viewAllPhotosButton.titleLabel?.font = .appFont(.bold, size: 14)
        viewAllPhotosButton.setTitle(TextConstants.homeLatestUploadsCardAllPhotosButtn, for: .normal)
        viewAllPhotosButton.setTitleColor(AppColor.settingsButtonColor.color, for: .normal)
