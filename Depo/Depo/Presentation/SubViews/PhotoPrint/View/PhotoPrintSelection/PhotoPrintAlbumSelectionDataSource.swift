//
//  PhotoPrintAlbumSelectionDataSource.swift
//  Depo
//
...
protocol PhotoPrintAlbumSelectionDataSourceDelegate: AnyObject {
    func onSelectAlbum(_ album: AlbumItem)
}

final class PhotoPrintAlbumSelectionDataSource: NSObject {
    
    private var collectionView: UICollectionView?
    private var albums = [AlbumItem]()
    weak var delegate: PhotoPrintAlbumSelectionDataSourceDelegate?
...
extension PhotoPrintAlbumSelectionDataSource: UICollectionViewDataSource {
...
extension PhotoPrintAlbumSelectionDataSource: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.onSelectAlbum(albums[indexPath.item])
    }
}

extension PhotoPrintAlbumSelectionDataSource: UICollectionViewDelegateFlowLayout {
