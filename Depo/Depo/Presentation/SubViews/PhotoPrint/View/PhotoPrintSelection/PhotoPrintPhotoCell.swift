...
final class PhotoPrintPhotoCell: UICollectionViewCell {
    ...
    func update(for selectionState: PhotoPrintPhotoSelectionState) {
        if self.isSelected {
...
final class PhotoPrintCollectionSpinnerFooter: UICollectionReusableView {
