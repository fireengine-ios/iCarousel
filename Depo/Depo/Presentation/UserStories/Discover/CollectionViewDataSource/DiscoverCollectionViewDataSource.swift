...
//  Lifebox
//
//  Created by Ozan Salman on 10.01.2023.
...
final class DiscoverCollectionViewDataSource: NSObject, BaseCollectionViewCellWithSwipeDelegate {
    
    private weak var delegate: DiscoverCollectionViewDataSourceDelegate?
    ...
    func configurateWith(collectionView: UICollectionView, viewController: UIViewController, delegate: DiscoverCollectionViewDataSourceDelegate?) {
        ...
        if let layout = collectionView.collectionViewLayout as? DiscoverCollectionViewLayout {
...
extension DiscoverCollectionViewDataSource: CardsManagerViewProtocol {
...
//        }
    ...
    func isEqual(object: CardsManagerViewProtocol) -> Bool {
        if let compairedView = object as? DiscoverCollectionViewDataSource {
...
extension DiscoverCollectionViewDataSource: UICollectionViewDataSource,  UICollectionViewDelegate {
...
extension DiscoverCollectionViewDataSource: CollectionViewDataSourceDelegate {
...
extension DiscoverCollectionViewDataSource: CardsShareButtonDelegate {
