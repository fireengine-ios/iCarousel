//
//  DiscoverCollectionViewLayout.swift
//  Lifebox
//
...
protocol CollectionViewDataSourceDelegate: UICollectionViewDelegate {
...
class DiscoverCollectionViewLayout: UICollectionViewLayout {
