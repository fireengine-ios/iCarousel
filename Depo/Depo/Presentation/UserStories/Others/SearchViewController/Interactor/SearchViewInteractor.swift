...
class SearchViewInteractor: SearchViewInteractorInput {
    ...
    private func getAlbumItem(forSearchItem item: SuggestionObject) {
        ...
        switch type {
        case .people:
            peopleService.getPeopleAlbum(id: Int(id), isHidden: false, success: { [weak self] albumResponse in
        ...
        case .thing:
            thingsService.getThingsAlbum(id: Int(id), isHidden: false, success: { [weak self] albumResponse in
        ...
        case .place:
            placesService.getPlacesAlbum(id: Int(id), isHidden: false, success: { [weak self] albumResponse in
