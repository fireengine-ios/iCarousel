...
final class SecurityInfoViewController: BaseViewController, NibInit, KeyboardHandler {
    ...
    @objc private func checkButtonStatus() {
        ...
        let shouldButtonActive = type == .apple ? (!recoveryEmail.isEmpty && !captchaAnswer.isEmpty) || !secretAnswer.isEmpty : (!secretAnswer.isEmpty && !captchaAnswer.isEmpty) || !recoveryEmail.isEmpty
