...
final class SecurityInfoViewController: BaseViewController, NibInit, KeyboardHandler {
    ...
    @objc private func checkButtonStatus() {
        ...
        let shouldButtonActive = type == .apple ? (!captchaAnswer.isEmpty && (!recoveryEmail.isEmpty || !secretAnswer.isEmpty)) : (!secretAnswer.isEmpty && !captchaAnswer.isEmpty) || !recoveryEmail.isEmpty
