...
//        tableView.register(nib, forCellReuseIdentifier: CellsIdConstants.baseUserInputCellViewID)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.row == 0){
            ...
            #if DEBUG
                cell.textInputField.text = "6257515test@gmail.com"//"+905373858714" //"testasdasdMail@notRealMail.yep"//"Aleksandr.Pestriakov@life.com.by"//"6257515test@gmail.com"
            #endif
            ...
            cell.textDelegate = self
            #if DEBUG
                cell.textInput.text = "Best6257515"//"test8714"//".FsddQ646"//".FsddQ646"//"Best6257515"
            #endif
            return cell
        }
    }
