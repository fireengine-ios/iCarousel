...
//        tableView.register(nib, forCellReuseIdentifier: CellsIdConstants.baseUserInputCellViewID)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.row == 0) {
            ...
            #if DEBUG
                cell.textInputField.text = "+905322104481"//"qwerty@my.com"// "test3@test.test"//"test2@test.test"//"testasdasdMail@notRealMail.yep"
            #endif
            ...
            cell.textDelegate = self
            #if DEBUG
                cell.textInput.text = "135246"//"qwerty"// "zxcvbn"//".FsddQ646"
            #endif
            return cell
        }
    }
