...
//        tableView.register(nib, forCellReuseIdentifier: CellsIdConstants.baseUserInputCellViewID)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if (indexPath.row == 0) {
            ...
            #if DEBUG
                cell.textInputField.text = "testasdasdMail@notRealMail.yep"//"qwerty@my.com"// "test3@test.test"//"test2@test.test"//"testasdasdMail@notRealMail.yep"
            #endif
            ...
            cell.textDelegate = self
            #if DEBUG
                cell.textInput.text = ".FsddQ646"//"qwerty"//"qwerty"// "zxcvbn"//".FsddQ646"
            #endif
            return cell
        }
    }
