...
final class LoginViewController: ViewController {
    ...
    override func viewDidLoad() {
        ...
        #if DEBUG
        loginEnterView.textField.text = "+375297911713"//"qwerty@my.com"// "test3@test.test"//"test2@test.test"//"testasdasdMail@notRealMail.yep"

        passwordEnterView.textField.text = "qweqwe"//"qwerty"// "zxcvbn"//".FsddQ646"
        #endif
    }
