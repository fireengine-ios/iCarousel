...
//  Depo_LifeTech
//
//  Created by Konstantin on 2/2/18.
...
public class SynchronizedArray<Element> {
    fileprivate let queue = DispatchQueue(label: DispatchQueueLabels.syncronizedArray, attributes: .concurrent)
...
public extension SynchronizedArray where Element: Equatable {
    func removeIfExists(_ element: Element) {
