...
- (id) initWithAlbum:(PhotoAlbum *) _album {
    if(self = [super init]) {
        ...
        CustomLabel *titleLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(25, self.topIndex + 30, 280, 20) withFont:[UIFont fontWithName:@"TurkcellSaturaDem" size:12] withColor:[Util UIColorForHexColor:@"363e4f"] withText:NSLocalizedString(@"AlbumAddTitle", @"")];
        ...
        CustomLabel *detailLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(25, nameField.frame.origin.y + nameField.frame.size.height + 30, 280, 20) withFont:[UIFont fontWithName:@"TurkcellSaturaDem" size:12] withColor:[Util UIColorForHexColor:@"363e4f"] withText:NSLocalizedString(@"AlbumDetailSegmentTitle", @"")];
        ...
        //item segment
        CustomLabel *itemsLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(25, detailSeparator.frame.origin.y + detailSeparator.frame.size.height + 15, 175, 25) withFont:[UIFont fontWithName:@"TurkcellSaturaDem" size:20] withColor:[Util UIColorForHexColor:@"363e4f"] withText:NSLocalizedString(@"AlbumDetailItems", @"")];
        ...
        //size segment
        CustomLabel *sizeLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(25, itemsSeparator.frame.origin.y + itemsSeparator.frame.size.height + 15, 175, 25) withFont:[UIFont fontWithName:@"TurkcellSaturaDem" size:20] withColor:[Util UIColorForHexColor:@"363e4f"] withText:NSLocalizedString(@"AlbumDetailSize", @"")];
        [self.view addSubview:sizeLabel];
        
        CustomLabel *sizeValueLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(200, itemsSeparator.frame.origin.y + itemsSeparator.frame.size.height + 15, 95, 25) withFont:[UIFont fontWithName:@"TurkcellSaturaMed" size:20] withColor:[Util UIColorForHexColor:@"707a8f"] withText:[Util transformedSizeValue:self.album.bytes]];
        ...
        //modify date segment
        CustomLabel *dateLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(25, sizeSeparator.frame.origin.y + sizeSeparator.frame.size.height + 15, 175, 25) withFont:[UIFont fontWithName:@"TurkcellSaturaDem" size:20] withColor:[Util UIColorForHexColor:@"363e4f"] withText:NSLocalizedString(@"AlbumDetailModifyDate", @"")];
        [self.view addSubview:dateLabel];
        
        NSDateFormatter *dateFormat = [[NSDateFormatter alloc] init];
        [dateFormat setDateFormat:@"dd MMM yyyy"];
        
        CustomLabel *dateValueLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(200, sizeSeparator.frame.origin.y + sizeSeparator.frame.size.height + 15, 95, 25) withFont:[UIFont fontWithName:@"TurkcellSaturaMed" size:20] withColor:[Util UIColorForHexColor:@"707a8f"] withText:[dateFormat stringFromDate:self.album.lastModifiedDate]];
