...
- (id)initWithFile:(MetaFile *) _file {
    ...
    if (self) {
        ...
        UIImageView *albumImgView = [[UIImageView alloc] initWithFrame:CGRectMake((self.view.frame.size.width - albumImg.size.width)/2, 80, albumImg.size.width, albumImg.size.height)];
        albumImgView.image = albumImg;
        [self.view addSubview:albumImgView];
        
        CustomLabel *titleLabel = [[CustomLabel alloc] initWithFrame:CGRectMake(0, albumImgView.frame.origin.y + albumImgView.frame.size.height + 20, self.view.frame.size.width, 22) withFont:[UIFont fontWithName:@"TurkcellSaturaBol" size:18] withColor:[UIColor whiteColor] withText:self.file.name];
