...
- (id)init
{
    infoTextOn = @"Your Music is visible within the app & manual uploading is available.\n\n(Tap on the \"+\" button to upload tracks from your iTunes Library on your iPhone.)";
