...
#define TTY_CONTACT_COUNT_URL @"https://contactsync.turkcell.com.tr/ttyapi/contact/count"
...
#define DETAILS_URL BASE_URL@"/filesystem/details"
...
#define ADVANCED_SEARCH_URL BASE_URL@"/search/unified?text=%@&sortBy=%@&sortOrder=%@&page=%d&size=%d"

//#define ADVANCED_SEARCH_URL_WITH_CATEGORY BASE_URL@"/search/advancedSearch?name=%@&sortBy=%@&sortOrder=%@&from=%d&size=%d&category=%@"
#define ADVANCED_SEARCH_URL_WITH_CATEGORY BASE_URL@"/search/unified?text=%@&sortBy=%@&sortOrder=%@&page=%d&size=%d&category=%@"
...
#define VIDEOFY_PREVIEW_URL BASE_URL@"/slideshow/preview"
