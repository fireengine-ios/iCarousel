...
extension BaseMetaData {
    override func isEqual(_ object: Any?) -> Bool {
        ...
        return takenDate == metaData.takenDate &&
            ...
            duration.asInt == metaData.duration.asInt &&
...
final class SuggestionObject: ObjectRequestResponse {
    ...
    func getHighlightedText(string: String!) -> NSMutableAttributedString! {
        if let _ = string {
            ...
            attributedString.addAttributes([NSAttributedString.Key.foregroundColor : AppColor.tint.color], range: highlightedText.range(of: sub))
