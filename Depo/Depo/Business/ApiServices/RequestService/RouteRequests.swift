...
struct RouteRequests {
    ...
    static let peopleRecovery = baseUrl.absoluteString + people + "recovery"
...
//    static let peopleDeletePhoto = "/person/photo/%d/%d"
    ...
    static let thingsRecovery = baseUrl.absoluteString + things + "recovery"
...
//    static let thingsDeletePhoto = "object/photo/%d/%d"
    ...
    static let placesRecovery = baseUrl.absoluteString + places + "recovery"
