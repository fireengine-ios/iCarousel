...
class SessionCustomService: SessionManager {
    ...
    open static let `shared`: SessionManager = {
        let configuration = URLSessionConfiguration.default
        configuration.httpAdditionalHeaders = SessionCustomService.defaultCustomHTTPHeaders
        
        return SessionManager(configuration: configuration)
    }()
    
    open static let defaultCustomHTTPHeaders: HTTPHeaders = {
