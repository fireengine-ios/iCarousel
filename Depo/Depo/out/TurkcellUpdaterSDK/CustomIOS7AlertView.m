...
- (UIView *)createContainerView
{
    ...
    // There is a line above the button
    UIView *titleLineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height / 5.0, dialogContainer.bounds.size.width, buttonSpacerHeight)];
    titleLineView.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
    [dialogContainer addSubview:titleLineView];
