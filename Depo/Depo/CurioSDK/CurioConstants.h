...
//  CurioIOSSDKSample
//
//  Created by Can Ciloglu on 30/01/15.
...
extern NSString * const CURKeySessionCode;
extern NSString * const CURHttpParamPushId;
extern NSString * const CURKeyDeviceToken;
extern NSString * const CURKeyLatitude;
extern NSString * const CURKeyLongitude;
extern NSString * const CURKeyNotificationId;
extern NSString * const CURKeyLocationId;
extern NSString * const CURNotificationTypes;
extern NSString * const CURKeyActionId;
extern NSString * const CURKeyActionType;
extern NSString * const CURKeyTimeStamp;
...
extern NSString * const CURKeyData;
extern NSString * const CURNetworkTypeWifi;
extern NSString * const CURNetworkTypeMobile;
...
extern NSString * const CURHttpParamTrackingCode;
extern NSString * const CURHttpParamCustomId;
extern NSString * const CURHttpParamLatitude;
extern NSString * const CURHttpParamLongitude;
extern NSString * const CURHttpParamOffset;
extern NSString * const CURHttpParamLimitSize;
