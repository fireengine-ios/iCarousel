...
#define IS_IPHONE_6P_OR_HIGHER (IS_IPHONE && SCREEN_MAX_LENGTH >= 736.0)
...
#define FAV_LIST_UPDATED_NOTIFICATION @"FAV_LIST_UPDATED_NOTIFICATION"
...
#define ALBUM_COVER_PHOTO_SET_NOTIFICATION @"ALBUM_COVER_PHOTO_SET_NOTIFICATION"
...
#define VIDEO_READY_TO_PLAY_NOTIFICATION @"VIDEO_READY_TO_PLAY_NOTIFICATION"
...
#define SHOW_STORAGEINFO_HIDDEN_KEY @"SHOW_STORAGEINFO_HIDDEN_KEY"
...
#define LOCAL_FILES_HASHES_KEY @"LOCAL_FILES_HASHES_KEY"

#define FIRST_SYNC_DONE_FLAG_KEY @"FIRST_SYNC_DONE_FLAG_KEY_%@"

#define ONE_TIME_SYNC_DONE_FLAG_KEY @"ONE_TIME_SYNC_DONE_FLAG_KEY_%@"
...
#define AUTO_ITERATION_FINISHED_NOT_KEY @"AUTO_ITERATION_FINISHED_NOT_KEY"

#define FB_AUTO_SYNC_SWITCH_KEY @"FB_AUTO_SYNC_SWITCH_KEY"

#define FB_AUTO_SYNC_STOP_ERR_NOT_KEY @"FB_AUTO_SYNC_STOP_ERR_NOT_KEY"
...
#define AUTO_SYNC_QUEUE_FINISHED_NOTIFICATION @"AUTO_SYNC_QUEUE_FINISHED_NOTIFICATION"

#define PHOTOS_SCREEN_AUTO_TRIGGERED_NOTIFICATION @"PHOTOS_SCREEN_AUTO_TRIGGERED_NOTIFICATION"
...
#define PERSISTENT_BASE_URL_CONSTANT_KEY_FOR_LOC_POPUP @"PERSISTENT_BASE_URL_CONSTANT_KEY_FOR_LOC_POPUP"
...
#define APP_FIRST_LAUNCH_FLAG @"APP_FIRST_LAUNCH_FLAG"
...
#define TUTORIAL_VIDEOFY_KEY @"TUTORIAL_VIDEOFY_KEY"
